...
<table border='1.5' width='600' cellpadding='1' cellspacing='1'>
	...
	<c:forEach items="${CurrentItems}" var="item">
			<tr>
				...
				<td><img src="/mywebproject/myImage/imageDisplay?id=${item.itemId}"/></td>
			</tr> 
	</c:forEach>
	<tr>
		<td> </td>
...
<p><a href="http://localhost:8080/mywebproject/item/list"> Add more to cart</a></p>
</center>
...
<form action="/mywebproject/item/checkOut?id=${CurrentUser.userName}" method="post">
	<table>
	<tr>
...
<%-- 
<c:url var="saveUrl" value="/mywebproject/item/checkOut?bid=${billableAttribute.billableId}&cid=${CurrentUser.userName}" />
