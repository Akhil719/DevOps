	...
	<c:forEach items="${items}" var="item">
			...
			<%-- <td><c:out value="${item.itemId}" /></td>  --%>
				...
				<td><img src="/mywebproject/myImage/imageDisplay?id=${item.itemId}"/></td>
	 			<td><a href="http://localhost:8080/mywebproject/item/addToUser?bid=${userName}&cid=${item.itemId}">Add</a> 
...
<div id="footer">
	<p><a href="http://localhost:8080/mywebproject/record/Logout">Logout</a></p>
</div>
